# Cuentiva Mobile & Desktop (`apps/mobile`)

Aplicación cliente multiplataforma desarrollada en **Flutter** para el sistema de recaudos y gestión de cartera **Cuentiva**. Soporta dispositivos móviles (**Android**, **iOS**) y escritorio (**Linux Desktop**, **Windows**).
