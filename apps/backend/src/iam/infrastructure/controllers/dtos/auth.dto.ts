...
export class RegisterDto {
  @ApiProperty({ example: 'admin@civica.com', description: 'Email del usuario (se usa como username)' })
  @IsString()
  @IsNotEmpty({ message: 'El nombre de usuario es requerido' })
  username: string;

  @ApiProperty({ example: 'SecureP@ss123', minLength: 6, description: 'Contraseña (mínimo 6 caracteres)' })
  @IsString()
  @IsNotEmpty()
  ...
  @ApiPropertyOptional({ description: 'Tenant ID (asignado automáticamente en la mayoría de casos)' })
  @IsString()
  @IsOptional()
  tenantId?: string;

  @ApiPropertyOptional({ description: 'ID del residente asociado (solo para rol RESIDENTE)' })
  @IsString()
  @IsOptional()
  residenteId?: string;
}
...
export class LoginDto {
  @ApiProperty({ example: 'admin@civica.com', description: 'Email / username del usuario' })
  @IsString()
  @IsNotEmpty({ message: 'El nombre de usuario es requerido' })
  username: string;
